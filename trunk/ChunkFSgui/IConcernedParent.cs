...
/**
 *  interface for a form that needs to track when some form it opened, closes 
 */
...
{
    public interface IConcernedParent
    {
        void notifyClosing(System.Windows.Forms.Form child);
    }
}
